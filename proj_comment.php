...
<script>
	function saveComments(ref) {
		...
		for(var i = 0; i < 10; i++) {		// array index corresponds to physical position on webpage (i.e: [0]=occ_hygiene; [1]=occ_hygiene_pic, etc)
...
<div id = "comments" >
	...
	<textarea name = "occ_hygiene" form = "comment_form"><?php
	 ...
	 ?></textarea>
	<br/>
	Name: <input type = "text" name = "occ_hygiene_pic" form = "comment_form" value = "<?php echo $row["occ_hygiene_pic"]; ?>">
	<br/>

	Safety Engineering:<br/>
	<textarea name = "safety_eng" form = "comment_form"><?php
	 ...
	 ?></textarea>
	<br/>
	Name: <input type = "text" name = "safety_eng_pic" form = "comment_form" value = "<?php echo $row["safety_eng_pic"]; ?>">
	<br/>

	Environmental Protection:<br/>
	<textarea name = "envr_protect" form = "comment_form"><?php
	 ...
	 ?></textarea>
	<br/>
	Name: <input type = "text" name = "envr_protect_pic" form = "comment_form" value = "<?php echo $row["envr_protect_pic"]; ?>">
	<br/>

	Health Physics: <br/>
	<textarea name = "health_phys" form = "comment_form"><?php
	 ...
	 ?></textarea>
	<br/>
	Name: <input type = "text" name = "health_phys_pic" form = "comment_form" value = "<?php echo $row["health_phys_pic"]; ?>">
	<br/>

	Peer Review:<br/>
	<textarea name = "peer_review" form = "comment_form"><?php
	 ...
	 ?></textarea>
	 <br/>
 	Name: <input type = "text" name = "peer_review_pic" form = "comment_form" value = "<?php echo $row["peer_review_pic"]; ?>">
 	<br/><br/>
